...
async function querySearchAND(filterValues, collection) {
    ...
    const currentNotesState = "";
    const currentState = "030000506000098071000000490009800000002010000380400609800030960100000004560982130";
    // { $and: [ { moves: { $elemMatch: { puzzleCurrentState: currentState, puzzleCurrentNotesState: currentNotesState } } } ] }
