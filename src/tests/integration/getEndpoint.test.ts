...
describe('Test GET requests for /api/v1/user/activeGames', function () {
    ...
    describe('Test code 200 GET requests', function () {
        ...
        it('GET by numHintsUsed query 200 and expected response', function (done) {
            request
                .get('/api/v1/user/activeGames')
        ...
        it('GET by numHintsUsedPerStrategy query 200 and expected response', function (done) {
            request
                .get('/api/v1/user/activeGames')
                .query(
    ...
    describe('Test code 400 GET requests', function () {
        ...
        it('Get numHintsUsed is not integer returns 400 error message', function (done) {
            request
                .get('/api/v1/user/activeGames')
    ...
    describe('Test code 404 GET requests', function () {
        ...
        it('Get numHintsUsed is not present returns 404 error message', function (done) {
            request
                .get('/api/v1/user/activeGames')
