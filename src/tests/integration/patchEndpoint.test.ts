...
describe('Test Patch requests for /api/v1/user/activeGames', function () {
    ...
    describe('Test code 200 PATCH requests', function () {
        describe('Test code 200 present PATCH requests', function () {
            ...
            it('Patch numHintsUsed query 200 with currentTime and expected response', function (done) {
                let patchBody;
                request
                    .patch('/api/v1/user/activeGames')
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ numHintsUsed: 0 })
                    .send({ numHintsUsed: 100 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .expect(200, [patchTestData.patchActivePuzzle1NumHintsUsedResponse()])
                    .expect(function(res) {
                        Assert.equal(JSON.stringify(patchBody), JSON.stringify(patchTestData.modified1Response));
                    })
                    .end(function(err, res) {
            ...
            it('Patch NAKED_SINGLE query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SINGLE': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_SINGLE': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SINGLE': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_SINGLE query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_PAIR query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_PAIR': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_TRIPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_QUADRUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_QUINTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_TRIPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_SEPTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch NAKED_OCTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_PAIR query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_TRIPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_QUADRUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_QUINTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_SEXTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_SEPTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch HIDDEN_OCTUPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch POINTING_PAIR query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.POINTING_PAIR': 9 })
                    .send({ 'numHintsUsedPerStrategy.POINTING_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.POINTING_PAIR': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch POINTING_TRIPLET query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': 9 })
                    .send({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch BOX_LINE_REDUCTION query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': 9 })
                    .send({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch X_WING query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.X_WING': 9 })
                    .send({ 'numHintsUsedPerStrategy.X_WING': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.X_WING': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch SWORDFISH query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.SWORDFISH': 9 })
                    .send({ 'numHintsUsedPerStrategy.SWORDFISH': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.SWORDFISH': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            it('Patch SINGLES_CHAINING query 200 with currentTime and expected response', function (done) {
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': 9 })
                    .send({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        patchBody = res.body;
                    })
                ...
                request
                    ...
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .query({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': 1000 })
                    .expect('Content-Type', /json/)
                    .expect(function(res) {
                        if (res.body[0] != undefined){
                            res.body[0]._id = "ID";
            ...
            // it('Patch by numHintsUsedPerStrategy query 200 and expected response', function (done) {
            //     request
            //         .patch('/api/v1/user/activeGames')
            //         .query(
            //             { 'numHintsUsedPerStrategy.NAKED_SINGLE': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_SINGLE': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_PAIR': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_TRIPLET': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.NAKED_OCTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_PAIR': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': 11 },
            //             { 'numHintsUsedPerStrategy.POINTING_PAIR': 11 },
            //             { 'numHintsUsedPerStrategy.POINTING_TRIPLET': 11 },
            //             { 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': 11 },
            //             { 'numHintsUsedPerStrategy.X_WING': 11 },
            //             { 'numHintsUsedPerStrategy.SWORDFISH': 11 },
            //             { 'numHintsUsedPerStrategy.SINGLES_CHAINING': 11 }
            //         )
            //         .set('Content-Type', 'application/json')
            //         .set('Authorization', 'Bearer ' + token)
            //         .expect('Content-Type', /json/)
        ...
        describe('Test code 200 not present PATCH requests', function () {
            ...
            it('Patch numHintsUsed is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ numHintsUsed: 100} )
                    .send({"currentTime": 100})
            ...
            it('Patch NAKED_SINGLE is not present 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_SINGLE': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_SINGLE is not present 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_PAIR is not present 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_PAIR': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_TRIPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_QUADRUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_QUINTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_SEXTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_SEPTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch NAKED_OCTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_PAIR is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_PAIR': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_TRIPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_QUADRUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_QUINTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_SEXTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_SEPTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch HIDDEN_OCTUPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch POINTING_PAIR is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.POINTING_PAIR': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch POINTING_TRIPLET is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch BOX_LINE_REDUCTION is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch X_WING is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.X_WING': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch SWORDFISH is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.SWORDFISH': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
            ...
            it('Patch SINGLES_CHAINING is not present returns 200 success message', function (done) {
                request
                    .patch('/api/v1/user/activeGames')
                    .query({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': 100 })
                    .send({"currentTime": 100})
                    .set('Content-Type', 'application/json')
                    .set('Authorization', 'Bearer ' + token)
                    .expect('Content-Type', /json/)
    ...
    describe('Test code 400 Patch requests', function () {
        ...
        it('Patch query numHintsUsed is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ numHintsUsed: "Banana"} )
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_SINGLE is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_SINGLE': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_SINGLE is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_QUADRUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_QUINTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_SEXTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_SEPTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query NAKED_OCTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_QUADRUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_QUINTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_SEXTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_SEPTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query HIDDEN_OCTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query POINTING_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.POINTING_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query POINTING_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query BOX_LINE_REDUCTION is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query X_WING is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.X_WING': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query SWORDFISH is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.SWORDFISH': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch query SINGLES_CHAINING is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .query({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body numHintsUsed is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ numHintsUsed: "Banana"} )
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_SINGLE is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_SINGLE': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_SINGLE is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_SINGLE': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_QUADRUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_QUADRUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_QUINTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_QUINTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_SEXTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_SEXTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_SEPTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_SEPTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body NAKED_OCTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.NAKED_OCTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_QUADRUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_QUADRUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_QUINTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_QUINTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_SEXTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_SEXTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_SEPTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_SEPTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body HIDDEN_OCTUPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.HIDDEN_OCTUPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body POINTING_PAIR is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.POINTING_PAIR': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body POINTING_TRIPLET is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.POINTING_TRIPLET': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body BOX_LINE_REDUCTION is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.BOX_LINE_REDUCTION': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body X_WING is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.X_WING': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body SWORDFISH is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.SWORDFISH': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
        ...
        it('Patch body SINGLES_CHAINING is not integer returns 400 error message', function (done) {
            request
                .patch('/api/v1/user/activeGames')
                .send({ 'numHintsUsedPerStrategy.SINGLES_CHAINING': "Banana" })
                .set('Content-Type', 'application/json')
                .set('Authorization', 'Bearer ' + token)
                .expect('Content-Type', /json/)
                .expect(400, globalTestData.ErrorMessage400)
